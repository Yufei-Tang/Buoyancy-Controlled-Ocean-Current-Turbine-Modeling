function OUT = gravity_buoyancy_3_VarBuoy_v2(states, mdl)
...
disp_mass_VarBuoy_front = mdl.VBC_VB*mdl.rho/2*tank_fill_front; %***
disp_mass_VarBuoy_back = mdl.VBC_VB*mdl.rho/2*tank_fill_back; %***
