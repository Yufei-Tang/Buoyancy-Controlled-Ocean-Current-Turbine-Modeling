function [mdl, rb] = turbine_constants_20mD_turbulence_VarBuoy(N_mesh)
mdl.g = 9.81;
mdl.rho = 1025.18;
...
%change the buoyancy and CB of the BCM
...
mdl.CDx_port_ear = mdl.Xcg(26); 
mdl.CDy_port_ear = (mdl.Ycg(26)-(13.234+20.626)/2*0.0254*(20/3));
mdl.CDz_port_ear = mdl.Zcg(26);
mdl.CDx_stbd_ear = mdl.Xcg(26);
mdl.CDy_stbd_ear = (mdl.Ycg(26)+(13.234+20.626)/2*0.0254*(20/3));
mdl.CDz_stbd_ear = mdl.Zcg(26);
mdl.CDx_body = (-(164.625/2-19.230)*0.0254-x_origin)*(20/3);
mdl.CDy_body = (0)*0.0254*(20/3);
mdl.CDz_body = (0)*0.0254*(20/3);
% mdl.CDx_bracket = mdl.Xcg(3);
% mdl.CDy_bracket = mdl.Ycg(3);
% mdl.CDz_bracket = mdl.Zcg(3);
...
mdl.L_body = 146.605*0.0254*(20/3);
mdl.D_body = 23.500*0.0254*(20/3);
mdl.L_ear = 92.000*0.0254*(20/3);
mdl.D_ear = 20.626*0.0254*(20/3);
%mdl.Ax_rotor = 3*((18+8)/2*50)*0.0254^2;
%mdl.Ay_rotor = ((11+2)/2*110)*0.0254^2;
%mdl.Az_rotor = ((11+2)/2*110)*0.0254^2;
...
mdl.Xcg_BCM = mdl.Xcg(26);
mdl.Ycg_BCM = mdl.Ycg(26);
mdl.Zcg_BCM = mdl.Zcg(26);
