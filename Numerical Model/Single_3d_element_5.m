function [sys,x0,str,ts] = Single_3d_element_5(t,x,u,flag,Mod_vars)
...
switch flag
    ...
    %%%%%%%%%%%%%%%%%%
    case 0
        [sys,x0,str,ts]=mdlInitializeSizes(Mod_vars,N_cable);
    ...
    case 2
        ...
        %%%%%%%%%%%
    case 3
        sys=mdlOutputs(t,x,u,Mod_vars,N_cable);
...
function [sys,x0,str,ts]=mdlInitializeSizes(Mod_vars,N_cable)

sizes = simsizes;
sizes.NumContStates  = 0;
sizes.NumDiscStates  = 0;
sizes.NumOutputs     = (N_cable+1)*3;
sizes.NumInputs      = (N_cable+1)*9+1;
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u,Mod_vars,N_cable)
...
for i=1:N_cable %for each section of the cable
    ...
    vel1 = LBI*([vx1-u((N_cable+1)*6+i) vy1-u((N_cable+1)*7+i) vz1-u((N_cable+1)*8+i)]');
    vel2 = LBI*([vx2-u((N_cable+1)*6+1+i) vy2-u((N_cable+1)*7+1+i) vz2-u((N_cable+1)*8+1+i)]');
